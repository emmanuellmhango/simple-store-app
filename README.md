...
# 📖 [SIMPLE STORE APP] <a name="about-project"></a>

**[SIMPLE STORE APP]** is a front end app to mimic an e-commercesite. It pulls data from the [FAKE_API](https://fakestoreapi.com/)
...
<details>
  <summary>API</summary>
  <ul>
    <li><a href="https://fakestoreapi.com/">FAKE API</a></li>
  </ul>
</details>
<details>
...
- [Live Demo Link](https://simple-store-app.onrender.com)
...
```sh
  cd my-folder
  git clone https://github.com/emmanuellmhango/simple-store-app.git
```
